...
class Log():
    ...
    def error(self,str):
        ...
        if self._debug_level == 0:
            self.__print(FONT_COLOR_RED + '[ Error ]: ' + FONT_COLOR_RESET + str)
        return self
    ...
    def success(self,str):
        ...
        """
        if self._debug_level == 0:
            self.__print(FONT_COLOR_GREEN + '[Success]: ' + FONT_COLOR_RESET + str)
        return self
    ...
    def warn(self,str):
        """
        Prints an Warning message on the console. [ Warng ] colored WHITE
        """
        if self._debug_level == 0:
            self.__print(FONT_COLOR_YELLOW + '[ Warng ]: ' + FONT_COLOR_RESET + str)
        return self
